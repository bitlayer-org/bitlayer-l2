...
type SubPool interface {
	...
	// SubscribeRebroadcastTxsEvent subscribes to rebroadcast transaction events.
	SubscribeRebroadcastTxsEvent(ch chan<- core.RebroadcastTxsEvent) event.Subscription
