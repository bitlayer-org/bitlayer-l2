...
func (api *API) ReadInternalTxs(db ethdb.Reader, hash common.Hash, number uint64) []*types.InternalTx {
...
func (api *API) TraceActionByBlockHash(ctx context.Context, hash common.Hash) (types.InternalTxs, error) {
	return types.TraceActionByBlockHash(api.backend, api, ctx, hash)
}
...
func (api *API) TraceActionByBlockNumber(ctx context.Context, number rpc.BlockNumber, filter *types.ActionConfig) (types.InternalTxs, error) {
	return types.TraceActionByBlockNumber(api.backend, api, ctx, number, filter)
}
...
func (api *API) TraceActionByTxHash(ctx context.Context, hash common.Hash, filter *types.ActionConfig) (*types.InternalTx, error) {
	return types.TraceActionByTxHash(api.backend, api, ctx, hash, filter)
}
