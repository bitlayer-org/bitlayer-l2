...
func (b *EthAPIBackend) FeeHistory2(ctx context.Context, blockCount uint64, lastBlock rpc.BlockNumber, rewardPercentiles []float64) (firstBlock *big.Int, reward [][]*big.Int, baseFee []*big.Int, gasUsedRatio []float64, err error) {
	return b.gpo.FeeHistory2(ctx, blockCount, lastBlock, rewardPercentiles)
}
